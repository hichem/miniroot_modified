...
UARCH := $(shell $(TOOLCHAIN_DIR)/utils.sh 'upper' '$(TARGET)')
...
SED_SCRIPT := $(SED_SCRIPT)s/.*CT_ARCH[= ].*/CT_ARCH=\"$(TARGET)\"/;
...
SED_SCRIPT := $(SED_SCRIPT)s/.*CT_ARCH_$(TARGET)[= ].*/CT_ARCH_$(TARGET)=y/;
